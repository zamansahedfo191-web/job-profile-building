...
def add_expenses():
    try:
        ...
        while True:
            ...
            if amount <= 0:
                amount = float(
                    input("Please enter a positive number as amount : ")
                )
                continue
...
def search_expense():
    try:
        ...
        with open("expenses.json", "r") as file:
            ...
            search = input(
                "Enter the name of expense you want to search : "
            )
...
def delete_expense():
    try:
        ...
        number = int(
            input(
                "Enter the serial number of expense you want to delete : "
            )
        )
        ...
        if 1 <= number <= len(expenses):
            ...
            with open("expenses.json", "w") as file:
                ...
                print(
                    f"Deleted : {deleted_expense['name']}",
    ...
    try:
        with open("expenses.json", "r") as file:
            ...
            if expenses:
                ...
                found = False
                choice = input(
                    "Enter the name of expense  you want to update : "
                )
                ...
                for expense in expenses:
                    if choice.lower() == expense["name"].lower():
                        ...
                        # Take new details
                        new_name = input(
                            "Enter your new expense name : "
                        )
                        new_amount = input(
                            "Enter your new expense amount : "
                        )
                        new_category = input(
                            "Enter your new expense category : "
                        )

                        while True:
                            if not new_name:
                                new_name = input(
                                    "Enter new expwnse name : "
                                )
                            ...
                            if not new_amount:
                                ...
                                new_amount = input(
                                    "Please enter new amount any positive number : "
                                )
                                continue
                            ...
                            if not new_category:
                                ...
                                if not new_category:
                                    print(
                                        "Empty category is not acceptable "
                                    )
                                    continue
    ...
    try:
        with open("expenses.json", "r") as file:
            ...
            if expenses:
                ...
                while True:
                    print(
                        "If you want to count how many repetation has "
                        "each categories then type 1 & for exit type 2 "
                    )
...
def compare_info():
    try:
        with open("expenses.json", "r") as file:
            ...
            if any_above_1000:
                print(
                    "\nIs there any expense amout above 1000 ? : ",
                    any_above_1000
                )
            ...
            if all_above_10:
                print(
                    "\nIs all expense amount above 10 :",
                    all_above_10
                )
...
def search_by_date():
    try:
        with open("expenses.json", "r") as file:
            ...
            for position, expense in enumerate(
                expenses,
                start=1
            ):
...
def category_month_report():
    try:
        ...
        for position, expense in enumerate(
            ...
            if (
                year + "-" + month == expense["date"][0:7]
                and categoryy == expense["category"]
            ):
                print(
                    f"{position}. "
                    f"{expense['name']} ~~ "
        ...
        if not found:
            print(
                "There is no expense match with your information "
            )
...
def category_result():
    try:
        ...
        print(
            "Average amount : ",
            sum(all_amount) / len(all_amount)
        )

        if not found:
            print(
                f"There is no expense category named {categoryy}"
            )
...
def category_spending_rank():
    try:
        ...
        avg_spending = (
            total_spending / len(category_totals)
        )
        ...
        print(
            "Amount : ",
            category_totals[highest]
        )

        print("\nLowest spending : ", lowest)
        print(
            "Amount : ",
            category_totals[lowest]
        )
...
def filtering_expense_amount():
    try:
        ...
        for expense in expenses:
            if (
                categoryy == expense["category"]
                and min_amount <= expense["amount"]
            ):
        ...
        print(
            f"For {categoryy} & minimum amount : "
            f"{min_amount} we have : "
        )
    ...
    try:
        ...
        if min_amount.lower() == "all":
            ...
            while True:
                ...
                if min_amount <= 0:
                    min_amount = input(
                        "Please enter any positive amount : "
                    )
                    continue
            ...
            if sorted_expense:
                ...
                avg_amount = (
                    total_expenses / len(sorted_expense)
                )
